...
<div id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <div id="logo">
            <a href="<?php echo G5_URL ?>"><img src="<?php echo G5_IMG_URL ?>/logo2.png" width="300px" height="80px" alt="<?php echo $config['cf_title']; ?>"></a>
        </div>
        ...
        <ul id="hd_qnb">
          <!--   <li><a href="<?php echo G5_BBS_URL ?>/faq.php"><i class="fa fa-question" aria-hidden="true"></i><span>FAQ</span></a></li> -->
            <li><a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=con00"><i class="fa fa-comments" aria-hidden="true"></i><span>제휴문의</span></a></li>
...
<div id="wrapper">
    <div id="container_wr">
<!--	<br>-->
<!--   <img src="/img/main.gif" width="1200" height="400">-->
    <div id="container">
